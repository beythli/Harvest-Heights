...
void cTexture::renderTexture(SDL_Renderer* theRenderer, SDL_Texture* ptheTexture, SDL_Rect* theSourceRect, SDL_Rect* theDestRect, double rotAngle, SDL_Point* spriteCentre)
{
	//SDL_RenderSetScale(theRenderer, theScaling.X, theScaling.Y);
